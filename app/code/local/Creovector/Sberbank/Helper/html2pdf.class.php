...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
            ...
            $this->_setDefaultMargins(5, 20, $marges[2], 20);
            $this->_setMargins();
            $this->_marges = array();
         ...
         * @return null
         */
        public function createIndex($titre = 'Index', $sizeTitle = 20, $sizeBookmark = 15, $bookmarkTitle = true, $displayPage = true, $onPage = null, $fontName = 'freesans')
        {
        ...
        protected function _listeGetLi()
        {
            ...
            switch($st)
            {
                ...
                case 'lower-alpha':
                    ...
                    return array('freesans', false, ($up ? strtoupper($str) : $str).'.');
                ...
                case 'decimal':
                    return array('freesans', false, $nb.'.');
